...
public class ChooseColorView extends RelativeLayout {
    ...
    private void init() {
        ...
        area1View.setOnClickListener(v -> {
        ...
        area2View.setOnClickListener(v -> {
        ...
        area3View.setOnClickListener(v -> {
        ...
        area4View.setOnClickListener(v -> {
        ...
        area5View.setOnClickListener(v -> {
        ...
        area6View.setOnClickListener(v -> {
        ...
        area7View.setOnClickListener(v -> {
        ...
        area8View.setOnClickListener(v -> {
        ...
        area9View.setOnClickListener(v -> {
        ...
        area10View.setOnClickListener(v -> {
        ...
        area11View.setOnClickListener(v -> {
        ...
        area12View.setOnClickListener(v -> {
