...
public class CookingPlanRecyclerViewAdapter extends RecyclerView.Adapter<CookingPlanRecyclerViewAdapter.ViewHolder> {

    private final List<Recipe> mValues;
    private RecipeListClickListener listener;
    private Context context;

    public CookingPlanRecyclerViewAdapter(List<Recipe> items, RecipeListClickListener listener, Context context) {
        mValues = items;
